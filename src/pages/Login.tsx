  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 px-4 py-12 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="absolute left-0 top-0 -z-10 h-full w-full overflow-hidden">
        <div className="absolute -left-20 -top-20 h-60 w-60 rounded-full bg-primary-300/20 blur-3xl filter dark:bg-primary-900/20"></div>
        <div className="absolute -bottom-40 -right-20 h-80 w-80 rounded-full bg-secondary-300/20 blur-3xl filter dark:bg-secondary-900/20"></div>
      ...
      <div className="w-full max-w-6xl">
        <div className="flex flex-col items-center justify-center lg:flex-row lg:items-stretch">
          {/* Brand section */}
